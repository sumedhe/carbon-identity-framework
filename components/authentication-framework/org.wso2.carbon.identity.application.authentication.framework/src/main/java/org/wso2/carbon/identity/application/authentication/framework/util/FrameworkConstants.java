...
public abstract class FrameworkConstants {
    ...
    public static final String OTP_VERIFICATION_PENDING_CLAIMS = "otpVerificationPendingClaims";
    public static final String VERIFICATION_TRIGGERED_CLAIMS = "otpVerificationTriggeredClaims";
